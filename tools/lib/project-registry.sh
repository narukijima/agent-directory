...
# Emit registry entries as "R<TAB>name<TAB>url<TAB>reason<TAB>revision" and structural
# errors as "E<TAB>detail". Fenced examples are never parsed as live entries.
